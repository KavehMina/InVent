...
namespace InVent.Services.BankServices
{
    public class BankService(IBankRepository repository)
    {
        ...
        //public async Task<ResponseModel<Bank>> GetAllBanks() => await repository.TestBank();
        ...
        public async Task<ResponseModel<Bank>> AddBank(Bank Bank)=>await repository.Add(Bank);
        //{
        ...
        public async Task<ResponseModel<Bank>> DeleteBank(Bank Bank)=>await repository.Delete(Bank);
        //{
