...
namespace InVent.Components.Pages.EntryEntity
{
    public partial class EditEntryDialog
    {
        ...
        protected override Task OnParametersSetAsync()
        {
            ...
            this.Tanker = this.Entry.Tanker;
            this.Filled = this.Entry.Filled;
            this.Damaged = this.Entry.Damaged;
            this.RefineryFilled = this.Entry.RefineryFilled;
            this.RefineryEmpty = this.Entry.RefineryEmpty;
            this.WarehouseFilled = this.Entry.WarehouseFilled;
            this.WarehouseEmpty = this.Entry.WarehouseEmpty;
            this.SetRefineryNet();
    ...
    //    {
    //        this.Date = this.Entry.Date;
    //        this.RefineryNet = this.Entry.RefineryFilled - this.Entry.RefineryEmpty;
    //        this.WarehouseNet = this.Entry.WarehouseFilled - this.Entry.WarehouseEmpty;
    //        this.Difference = this.WarehouseNet - this.RefineryNet;
    //        this.Average = (double)this.WarehouseNet / this.Entry.Filled;
    //        return base.OnParametersSetAsync();
    //    }
    //    private async Task<IEnumerable<Package>> SearchPackages(string value, CancellationToken token)
    //    {
    ...
    //    private void SetRefineryFilled(int? value)
    //    {
    //        this.Entry.RefineryFilled = (int)value;
    //        this.SetRefineryNet();
    //    }

    //    private void SetRefineryEmpty(int? value)
    //    {
    //        this.Entry.RefineryEmpty = (int)value;
    //        this.SetRefineryNet();
    //    }

    //    private void SetRefineryNet()
    //    {
    //        if (this.Entry.RefineryFilled != null && this.Entry.RefineryEmpty != null)
    //        {
    //            this.RefineryNet = this.Entry.RefineryFilled - this.Entry.RefineryEmpty;
    //        }
    //        else
    ...
    //                {
    //                    Id = this.Entry.Id,
    //                    Damaged = (int)this.Entry.Damaged,
    //                    Date = (DateTime)this.Date,
    //                    DeliveryOrderId = this.Entry.DeliveryOrder.Id,
    //                    Filled = (int)this.Entry.Filled,
    //                    PackageTypeId = this.Entry.Package.Id,
    //                    ProductId = this.Entry.Product.Id,
    //                    RefineryId = this.Entry.Refinery.Id,
    //                    TankerId = this.Entry.Tanker.Id,
    //                    RefineryEmpty = (int)this.Entry.RefineryEmpty,
    //                    RefineryFilled = (int)this.Entry.RefineryFilled,
    //                    WarehouseEmpty = (int)this.Entry.WarehouseEmpty,
    //                    WarehouseFilled = (int)this.Entry.WarehouseFilled,
